...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
   ...
   if( YESstellsym ) then
    ...
    do ii = 1, mn
     do ll = 0, llrad ; id = Ate(lvol,0,ii)%i(ll) ; Ate(lvol,ideriv,ii)%s(ll) = solution(id)
      ;               ; id = Aze(lvol,0,ii)%i(ll) ; Aze(lvol,ideriv,ii)%s(ll) = solution(id)
    ...
    do ii = 2, mn
     do ll = 0, llrad ; id = Ate(lvol,0,ii)%i(ll) ; Ate(lvol,ideriv,ii)%s(ll) = solution(id)
      ;               ; id = Aze(lvol,0,ii)%i(ll) ; Aze(lvol,ideriv,ii)%s(ll) = solution(id)
      ;               ; id = Ato(lvol,0,ii)%i(ll) ; Ato(lvol,ideriv,ii)%s(ll) = solution(id)
      ;               ; id = Azo(lvol,0,ii)%i(ll) ; Azo(lvol,ideriv,ii)%s(ll) = solution(id)
     enddo ! end of do ll;
    enddo ! end of do ii;
  ...
  case( 'P' )
   ...
   do ii = 1, mn
    do ll = 0, llrad
     ;                                    ; id = Ate(lvol,0,ii)%i(ll) ; solution(id) = Ate(lvol,ideriv,ii)%s(ll)
     ;                                    ; id = Aze(lvol,0,ii)%i(ll) ; solution(id) = Aze(lvol,ideriv,ii)%s(ll)
