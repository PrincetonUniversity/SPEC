...
C     .. Common Block for Error Message ..
      ...
      COMMON /RKCOM9/   REC
      SAVE   /RKCOM9/
!$OMP THREADPRIVATE(/RKCOM1/,/RKCOM2/,/RKCOM3/,/RKCOM4/,/RKCOM5/,/RKCOM6/,/RKCOM7/,/RKCOM8/,/RKCOM9/)
C     .. Parameters ..
      CHARACTER*6       SRNAME
...
C     .. External Subroutines ..
      EXTERNAL          CONST, MCONST, RKMSG, RKSIT, I1MACH, D1MACH
...
C     .. Common Block for Error Message ..
      ...
      COMMON /RKCOM9/   REC
      SAVE   /RKCOM9/
!$OMP THREADPRIVATE(/RKCOM1/,/RKCOM2/,/RKCOM3/,/RKCOM4/,/RKCOM5/,/RKCOM7/,/RKCOM8/,/RKCOM9/)
C     .. Parameters ..
      CHARACTER*6       SRNAME
      PARAMETER         (SRNAME='UT')
      LOGICAL           ASK, TELL
...
C     .. Common Block for Error Message ..
      ...
      COMMON /RKCOM9/   REC
      SAVE   /RKCOM9/
!$OMP THREADPRIVATE(/RKCOM1/,/RKCOM2/,/RKCOM3/,/RKCOM5/,/RKCOM6/,/RKCOM7/,/RKCOM8/,/RKCOM9/)
C     .. Parameters ..
      CHARACTER*6       SRNAME
      PARAMETER         (SRNAME='CT')
      LOGICAL           ASK, TELL
...
C     .. Common Block for Error Message ..
      ...
      COMMON /RKCOM9/   REC
      SAVE   /RKCOM9/
!$OMP THREADPRIVATE(/RKCOM1/,/RKCOM2/,/RKCOM5/,/RKCOM7/,/RKCOM8/,/RKCOM9/)
C     .. Parameters ..
      CHARACTER*6       SRNAME
