...
The results from SPEC should be compared to the semi-analytical evaluation performed with the attached matlab routines, which were written by Zhisong Qu and explained below.
