...
! the following variables constitute the namelist/globallist/; note that all variables in namelist need to be broadcasted in readin;
  ...
  REAL         :: dxdesc     =   1.0e-05
  REAL         :: ftoldesc   =   1.0e-09
  INTEGER      :: maxitdesc  =   1000
  INTEGER      :: Lwritedesc =   0
  INTEGER      :: nwritedesc =   1 
...
!latex \subsubsection{arrays diagnosing ``force-descent''}
!latex \begin{enumerate}
!latex \item When using a force-descent (Lfindzero=3), these arrays save information during iterations.
!latex \end{enumerate}

  INTEGER              ::  witdesc
  REAL,    allocatable ::  xdesc(:,:), fdesc(:), edesc(:) 
