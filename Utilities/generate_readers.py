...
MMpol.setDescription(r"The maximum value of \c Mpol is \c MMpol=32.")
MMpol.setType("int")
MMpol.setDefaultValue(32)
MMpol.setIsParameter(True)


MNtor = Variable("MNtor")
MNtor.setDescription(r"The maximum value of \c Ntor is \c MNtor=16.")
MNtor.setType("int")
MNtor.setDefaultValue(16)
