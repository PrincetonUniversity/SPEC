...
def grid(s,lvol=0,sarr=np.linspace(1,1,1),tarr=np.linspace(0,0,1),zarr=np.linspace(0,0,1)):
  
    Rarr0, Zarr0, _, _ = get_grid_and_jacobian_and_metric(s,lvol,sarr,tarr,zarr)
    return Rarr0, Zarr0

def jacobian(s,lvol=0,sarr=np.linspace(1,1,1),tarr=np.linspace(0,0,1),zarr=np.linspace(0,0,1)):

    _, _, jacobian, _ = get_grid_and_jacobian_and_metric(s,lvol,sarr,tarr,zarr)
    return jacobian

def metric(s,lvol=0,sarr=np.linspace(1,1,1),tarr=np.linspace(0,0,1),zarr=np.linspace(0,0,1)):
