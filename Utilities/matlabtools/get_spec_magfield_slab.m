function Bcontrav = get_spec_magfield_slab(fdata,lvol,sarr,tarr,zarr)
 
 
% Computes contravariant components of B in volume lvol in slab geometry
...
jac     = get_spec_jacobian_slab(fdata,lvol,sarr,tarr,zarr);  % get jacobian of the coordinates (stell sym)
