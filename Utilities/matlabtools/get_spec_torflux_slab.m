function psitor = get_spec_torflux_slab(fdata,lvol,zeta,start,send,ns,nt)

% Computes total enclosed toroidal flux in the poloidal cross-section defined by zeta, in slab geometry
...
if(ds==0 || dth==0)
 ...
 Bcontrav = get_spec_magfield_slab(fdata,lvol,sarr,tarr,zeta);
 ...
 jac      = get_spec_jacobian_slab(fdata,lvol,sarr,tarr,zeta);
