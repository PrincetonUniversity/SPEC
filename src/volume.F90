...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
    ...
    real(wp) :: vol(0:1), vint(1:Ntz)

    real(wp) :: Rei, Roi, Zei, Zoi, Rej, Roj, Zej, Zoj, Rek, Rok, Zek, Zok

    real(wp) :: AA, BB, CC, DD, lss
...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
    ...
    if (lvol .lt. 1 .or. lvol .gt. Mvol) then
        write (6, '("volume :      fatal : myid=",i3," ; lvol.lt.1 .or. lvol.gt.Mvol ; invalid volume ;")') myid
        call MPI_ABORT(MPI_COMM_SPEC, 1, ierr)
        stop "volume : lvol.lt.1 .or. lvol.gt.Mvol : invalid volume  ;"
    end if
    ! 15 Jan 13;
#endif
...
!>                   \f} </li>
            ...
            if (dBdX%L .and. dBdX%irz .eq. 1) then
                write (6, '("volume :      fatal : myid=",i3," ; dBdX%L .and. dBdX%irz.eq.1 ; volume does not depend on Z ;")') myid
                call MPI_ABORT(MPI_COMM_SPEC, 1, ierr)
                stop "volume : dBdX%L .and. dBdX%irz.eq.1 : volume does not depend on Z  ;"
            end if
...
!>                   \f} </li>
            ...
            if (dBdX%L .and. dBdX%irz .eq. 1) then
                write (6, '("volume :      fatal : myid=",i3," ; dBdX%L .and. dBdX%irz.eq.1 ; volume does not depend on Z for cylindrical geometry ;")') myid
                call MPI_ABORT(MPI_COMM_SPEC, 1, ierr)
                stop "volume : dBdX%L .and. dBdX%irz.eq.1 : volume does not depend on Z for cylindrical geometry  ;"
            end if
