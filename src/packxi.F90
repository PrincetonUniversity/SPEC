...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
    ...
    real(wp) :: position(0:NGdof), iRbc(1:mn, 0:Mvol), iZbs(1:mn, 0:Mvol), iRbs(1:mn, 0:Mvol), iZbc(1:mn, 0:Mvol)
        ...
        do jj = 1, mn ! loop over Fourier harmonics;
            ...
            do irz = 0, 1 ! loop over R & Z;
                ...
                do issym = 0, 1 ! loop over even & odd;
                    ...
                    if (idof .le. 0 .or. idof .gt. NGdof) then
                        write (6, '("packxi :      fatal : myid=",i3," ; idof.le.0 .or. idof.gt.NGdof ; out of bounds ;")') myid
                        call MPI_ABORT(MPI_COMM_SPEC, 1, ierr)
                        stop "packxi : idof.le.0 .or. idof.gt.NGdof : out of bounds  ;"
                    end if
...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
    ...
    if (idof .ne. NGdof) then
        write (6, '("packxi :      fatal : myid=",i3," ; idof.ne.NGdof ; counting error ;")') myid
        call MPI_ABORT(MPI_COMM_SPEC, 1, ierr)
        stop "packxi : idof.ne.NGdof : counting error  ;"
    end if
    ...
    case ('U')
        ...
        if ((Mvol .ne. 1) .and. (Lfindzero .ne. 0)) then
            if (LComputeAxis) then
                ...
                cput = MPI_WTIME()
                Tpackxi = Tpackxi + (cput - cpuo)
                call rzaxis(Mvol, mn, iRbc(1:mn, 0:Mvol), iZbs(1:mn, 0:Mvol), iRbs(1:mn, 0:Mvol), iZbc(1:mn, 0:Mvol), ivol, LComputeDerivatives)
                cpuo = MPI_WTIME()
