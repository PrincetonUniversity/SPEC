...
subroutine xspech
  ...
  if( myid.eq.0 ) then
    ...
    write(ounit,*)"      :  compiled  : date    = Thu Jun 17 17:07:05 EDT 2021 ; "
    write(ounit,*)"      :            : srcdir  = /u/bmedasan/Research/PPPL/SPEC/build1 ; "
    write(ounit,*)"      :            : macros  = /u/bmedasan/Research/PPPL/SPEC/src/macros ; "
    write(ounit,*)"      :            : fc      = /usr/pppl/intel/2019.u3/bin/ifort ; "
    write(ounit,*)"      :            : flags   = -cpp;$<$<Fortran_COMPILER_ID:GNU>:-ffree-line-length-none>;$<$<Fortran_COMPILER_ID:GNU>:-fdefault-real-8>;$<$<Fortran_COMPILER_ID:GNU>:-fbounds-check>;$<$<Fortran_COMPILER_ID:GNU>:-fexternal-blas>;$<$<Fortran_COMPILER_ID:Intel>:-r8> ; "
