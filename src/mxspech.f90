...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
  ...
  if( myid.eq.0 ) then
   write(ounit,'("xspech : ", 10x ," : version = "F5.2)') version
    write(ounit,*)"      :  compiled  : date    = Mon Nov  2 16:20:20 EST 2020 ; "
    write(ounit,*)"      :            : srcdir  = /u/bmedasan/Research/PPPL/SPEC ; "
    write(ounit,*)"      :            : macros  = /u/bmedasan/Research/PPPL/SPEC/src/macros ; "
    write(ounit,*)"      :            : fc      = /usr/pppl/intel/2019-pkgs/openmpi-4.0.3/bin/mpifort ; "
    write(ounit,*)"      :            : flags   =  ; "
