...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
    ...
    real(wp) :: sti(1:2), ltransform(1:2)
    real(wp), allocatable :: data(:, :, :, :), fiota(:, :)
    ...
    do vvol = 1, Mvol
        ...
        ! sets e.g. Lcoordinatesingularity
...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
    ...
    do vvol = 1, Mvol
        ...
        if (myid .eq. modulo(vvol - 1, ncpu) .and. myid .lt. Mvol) then ! the following is in parallel; 20 Jun 14;
            ...
            allocate (data(ioff:lnPtrj, 1:4, 0:Nz - 1, 1:nPpts), stat=astat)
            data(ioff:lnPtrj, 1:4, 0:Nz - 1, 1:nPpts) = zero
            ! for block writing to file (allows faster reading of output data files for post-processing plotting routines);

            allocate (utflag(ioff:lnPtrj), stat=astat)
            utflag(ioff:lnPtrj) = 0
            ! error flag that indicates if fieldlines successfully followed; 22 Apr 13;

            allocate (fiota(ioff:lnPtrj, 1:2), stat=astat)
            fiota(ioff:lnPtrj, 1:2) = zero
            ! will always need fiota(0,1:2);
...
!$OMP PARALLEL DO SHARED(lnPtrj,ioff,Wpp00aa,Nz,data,fiota,utflag,iota,oita,myid,vvol,cpus,Lconstraint,nPpts,ppts) PRIVATE(itrj,sti)
            do itrj = ioff, lnPtrj ! initialize Poincare plot with trajectories regularly spaced between interfaces along \t=0;
                ...
                cput = MPI_WTIME()
                Tpp00aa = Tpp00aa + (cput - cpuo)
                call pp00ab(vvol, sti(1:2), Nz, nPpts, data(itrj, 1:4, 0:Nz - 1, 1:nPpts), fiota(itrj, 1:2), utflag(itrj))
                cpuo = MPI_WTIME()
...
!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!-!
            ...
            deallocate (data, stat=astat)

            deallocate (utflag, stat=astat)

            deallocate (fiota, stat=astat)
