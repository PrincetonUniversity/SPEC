...
!> @{
  ...
  REAL         :: dxdesc     =   1.0e-03 !< descent time step parameter
  REAL         :: ftoldesc   =   1.0e-10 !< descent force tolerance
  INTEGER      :: maxitdesc  =   15000   !< maximum number of descent steps
  INTEGER      :: Lwritedesc =   1       !< to write middle steps during descent
  INTEGER      :: nwritedesc =   100     !< write a step for every nwritedesc steps
  INTEGER      :: Manderson  =   1       !< Anderson mixing parameter
!> @}
