...
! they go into ext.h5/input/physics
  ...
  H5DESCR_CDSET( /input/physics/rtor, z length of a slab or cylinder,                                                                  __FILE__, __LINE__)
  HWRITERV_LO( grpInputPhysics,         1, rpol       , (/ rpol           /),                                                          __FILE__, __LINE__)
  H5DESCR_CDSET( /input/physics/rpol, y length of a slab,                                                                              __FILE__, __LINE__)
