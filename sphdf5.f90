...
! they go into ext.h5/input/physics
  ...
  HWRITEIV_LO( grpInputPhysics,         1, Lboundary  , (/ Lboundary      /),                                                          __FILE__, __LINE__)
  H5DESCR_CDSET( /input/physics/Lboundary, boundary representation flag,                                                               __FILE__, __LINE__)
  HWRITEIV_LO( grpInputPhysics,         1, twoalpha   , (/ twoalpha       /),                                                          __FILE__, __LINE__)
  H5DESCR_CDSET( /input/physics/twoalpha , boundary representation parameter,                                                          __FILE__, __LINE__)
